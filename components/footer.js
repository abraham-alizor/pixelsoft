		...
		<div>
			<div>
				<footer
					...
					className='text-center lg:text-left  text-gray-600 bg-footer'
				>
					<div className='mx-6 py-20 text-center md:text-left'>
						<div className='lg:flex justify-between flex-row'>
							...
							<div className='pt-6 lg:pt-0 w-full lg:w-1/2 flex flex-row justify-between'>
								<div>
									<h6 className='text-gray-200 uppercase font-semibold mb-4 flex justify-center md:justify-start'>
										Product
									</h6>
					...
					>
						<div className='mr-12 hidden lg:block'>
							<span>© 2021 T360 Inc. All rights reserved</span>
						</div>
